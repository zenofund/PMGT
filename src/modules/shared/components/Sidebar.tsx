...
const sidebarItems: SidebarItem[] = [
  {
    ...
    icon: "📊",
    path: "/dashboard",
    roles: [ROLES.SUPER_ADMIN, ROLES.LANDLORD, ROLES.TENANT, ROLES.STAFF],
  },
  {
    label: "Super Admin",
    icon: "👑",
    path: MODULE_PATHS.SUPER_ADMIN,
    roles: [ROLES.SUPER_ADMIN],
  },
  {
    label: "Properties",
    icon: "🏠",
    path: MODULE_PATHS.PROPERTY,
    roles: [ROLES.LANDLORD, ROLES.SUPER_ADMIN],
  },
  {
    label: "Tenants",
    icon: "👥",
  ...
  },
  {
    label: "Payments",
    icon: "💳",
    path: MODULE_PATHS.PAYMENTS,
    roles: [ROLES.LANDLORD, ROLES.TENANT, ROLES.SUPER_ADMIN],
  },
  {
    label: "Maintenance",
    icon: "🔧",
    path: MODULE_PATHS.MAINTENANCE,
    roles: [ROLES.LANDLORD, ROLES.TENANT, ROLES.STAFF, ROLES.SUPER_ADMIN],
  },
  {
    label: "Accounting",
    icon: "📈",
    path: MODULE_PATHS.ACCOUNTING,
    roles: [ROLES.LANDLORD, ROLES.SUPER_ADMIN],
  },
  {
    label: "Reports",
  ...
  },
  {
    label: "Communication",
    icon: "💬",
    path: MODULE_PATHS.COMMUNICATION,
    roles: [ROLES.LANDLORD, ROLES.TENANT, ROLES.SUPER_ADMIN],
  },
  {
    label: "Settings",
    ...
    roles: [ROLES.SUPER_ADMIN, ROLES.LANDLORD],
  },
];
